...
use App\Filament\Resources\DaftarPenerimaBOPResource\Pages;
use App\Filament\Resources\DaftarPenerimaBOPResource\RelationManagers;
use App\Models\Bpp;
...
class DaftarPenerimaBOPResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListDaftarPenerimaBOPS::route('/'),
            'create' => Pages\CreateDaftarPenerimaBOP::route('/create'),
            'edit' => Pages\EditDaftarPenerimaBOP::route('/{record}/edit'),
        ];
    }
}
